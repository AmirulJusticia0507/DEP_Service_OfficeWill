...
<x-data-table :headers="['', 'Nama Kursus', 'Kategori', 'Passing Score', 'Retest', '']">
    ...
    <tr>
        <td class="w-14">
            ...
            @else
                <div class="w-12 h-9 bg-slate-100 dark:bg-navy-900 rounded border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-300 dark:text-slate-600 text-xs">No</div>
            @endif
        </td>
    ...
    @empty
    <tr><td colspan="6" class="text-center text-slate-400 dark:text-slate-500 py-6">Tidak ada kursus.</td></tr>
    @endforelse
</x-data-table>
