...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
    ...
    <div class="bg-white shadow rounded p-5 border-t-2 border-blue-500 dark:bg-navy-800">
        <p class="text-xs text-slate-500 font-medium uppercase tracking-wide dark:text-slate-300">{{ __('Certificates Issued') }}</p>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    <div class="bg-white shadow rounded p-5 dark:bg-navy-800">
        <h3 class="text-sm font-semibold text-slate-700 dark:text-slate-200 mb-4">{{ __('Completion Rate per Course (Top 10)') }}</h3>
        <canvas id="completionChart" height="200"></canvas>
    </div>
    <div class="bg-white shadow rounded p-5 dark:bg-navy-800">
        <h3 class="text-sm font-semibold text-slate-700 dark:text-slate-200 mb-4">{{ __('Monthly Completions') }}</h3>
