...
<div class="flex items-center justify-between mb-4">
    <h2 class="text-lg font-bold text-primary">Position Master</h2>
...
<x-data-table :headers="['Job ID', 'Job Title', 'Display Order', 'Action']">
    ...
    <tr>
        ...
        <td>
            <a href="{{ route('admin.positions.edit', $pos) }}" class="text-primary hover:underline text-xs font-medium">Edit</a>
